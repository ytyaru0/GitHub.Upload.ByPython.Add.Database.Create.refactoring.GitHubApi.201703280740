...
import database.src.repo.insert.github.common.RequestParam
import database.src.repo.insert.github.repositories.Languages
class Main:
    def __init__(self, data, client):
        self.data = data
        self.request_param = database.src.repo.insert.github.common.RequestParam.RequestParam(self.data.path_db_account, self.data.path_db_api, self.data.get_username())
        self.client = client
        self.inserter = database.src.repo.insert.command.repositories.Inserter.Inserter(self.data, self.client)
#        self.inserter = database.src.repo.insert.command.repositories.Inserter.Inserter(self.data)
