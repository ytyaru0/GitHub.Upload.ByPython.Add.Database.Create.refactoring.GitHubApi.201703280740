...
import json
import datetime
#import database.src.repo.insert.github.common.RequestParamRequestParam
#import database.src.repo.insert.github.miscellaneous.Licenses
#import database.src.repo.insert.github.repositories.Repositories
class Inserter:
    def __init__(self, data, client):
        self.data = data
        self.client = client
#        self.license = database.src.repo.insert.github.miscellaneous.Licenses.Licenses(self.data)
...
#        repository = database.src.repo.insert.github.repositories.Repositories.Repositories(request_param)
#        jsons = repository.list(sort='created', direction='asc', per_page=100)
#        jsons = self.client.repo.list(sort='created', direction='asc', per_page=100)
