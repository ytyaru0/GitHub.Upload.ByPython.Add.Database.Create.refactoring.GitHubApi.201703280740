...
import os.path
import subprocess
import uploader.command.repository.Creator
import uploader.command.repository.Commiter
import uploader.command.repository.Deleter
import uploader.command.repository.Editor
import uploader.command.aggregate.Aggregate

class Main:
    def __init__(self, data, client):
        self.data = data
        self.client = client
        self.creator = uploader.command.repository.Creator.Creator(self.data, self.client)
        self.commiter = uploader.command.repository.Commiter.Commiter(self.data, self.client)
        self.deleter = uploader.command.repository.Deleter.Deleter(self.data, self.client)
        self.editor = uploader.command.repository.Editor.Editor(self.data, self.client)
        self.agg = uploader.command.aggregate.Aggregate.Aggregate(self.data)
#        self.creator = uploader.command.repository.Creator.Creator(self.data)
#        self.commiter = uploader.command.repository.Commiter.Commiter(self.data)
#        self.deleter = uploader.command.repository.Deleter.Deleter(self.data)
#        self.editor = uploader.command.repository.Editor.Editor(self.data)
#        self.agg = uploader.command.aggregate.Aggregate.Aggregate(self.data)
